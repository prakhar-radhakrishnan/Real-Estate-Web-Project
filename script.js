...
! function(t) {
    ...
    function _t(t) {
        ...
        var x = X(c, w, i, s, y, l);
        r.dispatch((0, _.instanceAdded)((0, a.default)({ instanceId: g, elementId: O, origin: x, refType: A, skipMotion: S, skipToValue: n }, o))), mt(document.body, "ix2-animation-started", g), f ? function(t, e) {
    ...
    t.exports = function() {
        ...
        return t.template = function(e, n, r) {
            ...
            var u, c = n.variable;
            if (c) { if (!m.test(c)) throw new Error("variable is not a bare identifier: " + c) } else a = "with(obj||{}){\n" + a + "}\n", c = "obj";
            ...
            case K:
                return function(t, e, n, r, i) {
                    var o = Ct.map(function(t) {
                        ...
                        a = i.setStyle;
                    Dt(t, _.TRANSFORM_PREFIXED, i), a(t, _.TRANSFORM_PREFIXED, o), u = r, c = n, s = u.actionTypeId, f = c.xValue, l = c.yValue, d = c.zValue, (s === J && void 0 !== d || s === tt && void 0 !== d || s === et && (void 0 !== f || void 0 !== l)) && a(t, _.TRANSFORM_STYLE_PREFIXED, x);
                    var u, c, s, f, l, d
                }(t, e, n, i, a);
            case q:
    ...
    var f = s(n(270)),
        ...
        vt = Object.freeze((i = {}, (0, c.default)(i, _.TRANSFORM_PREFIXED, I), (0, c.default)(i, M, m), (0, c.default)(i, N, N), (0, c.default)(i, C, C), (0, c.default)(i, P, P), (0, c.default)(i, D, D), (0, c.default)(i, L, L), i)),
        ht = {},
        Et = 1;
    var gt = 1;
    var _t = function(t, e) { return t === e };

    function yt(t) { var e = (0, u.default)(t); return "string" === e ? { id: t } : null != t && "object" === e ? { id: t.id, objectId: t.objectId, selector: t.selector, selectorGuids: t.selectorGuids, appliesTo: t.appliesTo, useEventTarget: t.useEventTarget } : {} }
    ...
    function mt(t) {
        ...
        if (A === v.EventAppliesTo.PAGE) { var x = f(T); return x ? [x] : [] }
        var R, N, C, L = (null !== (e = null == o ? void 0 : null === (n = o.action) || void 0 === n ? void 0 : null === (r = n.config) || void 0 === r ? void 0 : r.affectedElements) && void 0 !== e ? e : {})[T || O] || {},
            ...
            D = o && l(yt(o.target));
        if (P ? (R = L.limitAffectedElements, N = D, C = l(L)) : N = C = l({ id: T, selector: O, selectorGuids: w }), o && S) { var M = a && (C || !0 === S) ? [a] : d(D); if (C) { if (S === V) return d(C).filter(function(t) { return M.some(function(e) { return g(t, e) }) }); if (S === k) return d(C).filter(function(t) { return M.some(function(e) { return g(e, t) }) }); if (S === G) return d(C).filter(function(t) { return M.some(function(e) { return y(e, t) }) }) } return M }
        return null == N || null == C ? [] : _.IS_BROWSER_ENV && u ? d(C).filter(function(t) { return u.contains(t) }) : R === k ? d(N, C) : R === X ? p(d(N)).filter(E(C)) : R === G ? h(d(N)).filter(E(C)) : d(C)
    }
    var It = /px/,
        Tt = function(t, e) { return e.reduce(function(t, e) { return null == t[e.type] && (t[e.type] = xt[e.type]), t }, t || {}) },
        bt = function(t, e) { return e.reduce(function(t, e) { return null == t[e.type] && (t[e.type] = Rt[e.type] || e.defaultValue || 0), t }, t || {}) };
    ...
    function Ft(t) {
        ...
        e.actionItems.forEach(function(t) {
            var e, i = t.actionTypeId,
                o = t.config;
            e = (0, g.isPluginType)(i) ? (0, g.clearPlugin)(i) : kt({ effect: Xt, actionTypeId: i, elementApi: r }), mt({ config: o, event: n, elementApi: r }).forEach(e)
        })
    }
    var kt = function(t) {
        var e = t.effect,
    ...
    var c, s, f, l = u(n(30)),
        ...
        gt = (r = {}, (0, o.default)(r, x, vt()), (0, o.default)(r, R, ht()), (0, o.default)(r, S, vt()), (0, o.default)(r, A, ht()), (0, o.default)(r, P, vt(!1)), (0, o.default)(r, L, ht(!1)), (0, o.default)(r, N, vt()), (0, o.default)(r, C, ht()), (0, o.default)(r, U, { types: "ecommerce-cart-open", handler: et(Z, tt) }), (0, o.default)(r, V, { types: "ecommerce-cart-close", handler: et(Z, tt) }), (0, o.default)(r, m, {
            types: "click",
    ...
    r.define("dropdown", t.exports = function(t, e) {
        ...
        function x(e, i) {
            ...
            var E = N(f, a);
            n && f.el.on(w, function(t) { return function(e, n) { n = n || {}, R(t), !0 === n.open && C(t), !1 === n.open && L(t, { immediate: !0 }) } }(f)), n || (l && (f.hovering = !1, L(f)), f.config.hover && f.toggle.on(m, function(t) { return function() { t.hovering = !0, C(t) } }(f)), f.el.on(O, E), f.el.on(y, function(t) {
                return function(e) {
    ...
    r.define("slider", t.exports = function(t, e) {
        ...
        function m() { r.resize.off(I), r.redraw.off(s.redraw) }
        ...
        function T(e, n) {
            var r = t(n),
                i = t.data(n, p);
            i || (i = t.data(n, p, { index: 0, depth: 1, hasFocus: { keyboard: !1, mouse: !1 }, el: r, config: {} })), i.mask = r.children(".w-slider-mask"), i.left = r.children(".w-slider-arrow-left"), i.right = r.children(".w-slider-arrow-right"), i.nav = r.children(".w-slider-nav"), i.slides = i.mask.children(".w-slide"), i.slides.each(g.reset), _ && (i.maskWidth = 0), void 0 === r.attr("role") && r.attr("role", "region"), void 0 === r.attr("aria-label") && r.attr("aria-label", "carousel");
            ...
            if (e.index !== e.previous) {
                if (u || e.ariaLiveLabel.text("Slide ".concat(o + 1, " of ").concat(i.length, ".")), "cross" === y) {
                    var w = Math.round(I - I * r.crossOver),
                        A = Math.round(I - w);
                    return b = "opacity " + w + "ms " + m, f(h).set({ visibility: "" }).add(b).start({ opacity: 0 }), void f(v).set({ visibility: "", x: d, opacity: 0, zIndex: e.depth++ }).add(b).wait(A).then({ opacity: 1 }).then(S)
                }
                if ("fade" === y) return f(h).set({ visibility: "" }).stop(), void f(v).set({ visibility: "", x: d, opacity: 0, zIndex: e.depth++ }).add(b).start({ opacity: 1 }).then(S);
                if ("over" === y) return p = { x: e.endX }, f(h).set({ visibility: "" }).stop(), void f(v).set({ visibility: "", zIndex: e.depth++, x: d + i[e.index].width * T }).add(O).start({ x: d }).then(S);
                r.infinite && c.x ? (f(e.slides.not(h)).set({ visibility: "", x: c.x }).add(O).start({ x: d }), f(h).set({ visibility: "", x: c.from }).add(O).start({ x: c.to }), e.shifted = h) : (r.infinite && e.shifted && (f(e.shifted).set({ visibility: "", x: l }), e.shifted = null), f(e.slides).set({ visibility: "" }).add(O).start({ x: d }))
            }
 ...
 */
Webflow.require('ix2').init({ "events": { "e": { "id": "e", "name": "", "animationType": "custom", "eventTypeId": "MOUSE_CLICK", "action": { "id": "", "actionTypeId": "GENERAL_START_ACTION", "config": { "delay": 0, "easing": "", "duration": 0, "actionListId": "a", "affectedElements": {}, "playInReverse": false, "autoStopEventId": "e-2" } }, "mediaQueries": ["main", "medium", "small", "tiny"], "target": { "id": "63ff56d9e6a8a31c5bd85093|7e607eac-20f4-7b40-3acc-cb7890da4d73", "appliesTo": "ELEMENT", "styleBlockIds": [] }, "targets": [{ "id": "63ff56d9e6a8a31c5bd85093|7e607eac-20f4-7b40-3acc-cb7890da4d73", "appliesTo": "ELEMENT", "styleBlockIds": [] }], "config": { "loop": false, "playInReverse": false, "scrollOffsetValue": null, "scrollOffsetUnit": null, "delay": null, "direction": null, "effectIn": null }, "createdOn": 1677922615069 }, "e-3": { "id": "e-3", "name": "", "animationType": "custom", "eventTypeId": "MOUSE_CLICK", "action": { "id": "", "actionTypeId": "GENERAL_START_ACTION", "config": { "delay": 0, "easing": "", "duration": 0, "actionListId": "a-2", "affectedElements": {}, "playInReverse": false, "autoStopEventId": "e-4" } }, "mediaQueries": ["main", "medium", "small", "tiny"], "target": { "id": "63ff56d9e6a8a31c5bd85093|616cf916-c718-4b7a-6128-50d1d782fc52", "appliesTo": "ELEMENT", "styleBlockIds": [] }, "targets": [{ "id": "63ff56d9e6a8a31c5bd85093|616cf916-c718-4b7a-6128-50d1d782fc52", "appliesTo": "ELEMENT", "styleBlockIds": [] }], "config": { "loop": false, "playInReverse": false, "scrollOffsetValue": null, "scrollOffsetUnit": null, "delay": null, "direction": null, "effectIn": null }, "createdOn": 1677925171826 }, "e-5": { "id": "e-5", "name": "", "animationType": "custom", "eventTypeId": "MOUSE_CLICK", "action": { "id": "", "actionTypeId": "GENERAL_START_ACTION", "config": { "delay": 0, "easing": "", "duration": 0, "actionListId": "a-3", "affectedElements": {}, "playInReverse": false, "autoStopEventId": "e-6" } }, "mediaQueries": ["main", "medium", "small", "tiny"], "target": { "id": "63ff56d9e6a8a31c5bd85093|0681a91b-4715-4edc-df55-ce9235bea9cc", "appliesTo": "ELEMENT", "styleBlockIds": [] }, "targets": [{ "id": "63ff56d9e6a8a31c5bd85093|0681a91b-4715-4edc-df55-ce9235bea9cc", "appliesTo": "ELEMENT", "styleBlockIds": [] }], "config": { "loop": false, "playInReverse": false, "scrollOffsetValue": null, "scrollOffsetUnit": null, "delay": null, "direction": null, "effectIn": null }, "createdOn": 1677925188321 } }, "actionLists": { "a": { "id": "a", "title": "modal-close", "actionItemGroups": [{ "actionItems": [{ "id": "a-n", "actionTypeId": "GENERAL_DISPLAY", "config": { "delay": 0, "easing": "", "duration": 0, "target": { "useEventTarget": "PARENT", "selector": ".modal-wrapper", "selectorGuids": ["50705755-d766-1a4f-3bd7-5516c898166e"] }, "value": "none" } }] }], "useFirstGroupAsInitialState": false, "createdOn": 1677922835335 }, "a-2": { "id": "a-2", "title": "open-modal", "actionItemGroups": [{ "actionItems": [{ "id": "a-2-n", "actionTypeId": "GENERAL_DISPLAY", "config": { "delay": 0, "easing": "", "duration": 0, "target": { "selector": ".modal-wrapper", "selectorGuids": ["50705755-d766-1a4f-3bd7-5516c898166e"] }, "value": "flex" } }] }], "useFirstGroupAsInitialState": false, "createdOn": 1677923030591 }, "a-3": { "id": "a-3", "title": "open-modal 2", "actionItemGroups": [{ "actionItems": [{ "id": "a-3-n", "actionTypeId": "GENERAL_DISPLAY", "config": { "delay": 0, "easing": "", "duration": 0, "target": { "selector": ".modal-wrapper", "selectorGuids": ["50705755-d766-1a4f-3bd7-5516c898166e"] }, "value": "flex" } }] }], "useFirstGroupAsInitialState": false, "createdOn": 1677923030591 } }, "site": { "mediaQueries": [{ "key": "main", "min": 992, "max": 10000 }, { "key": "medium", "min": 768, "max": 991 }, { "key": "small", "min": 480, "max": 767 }, { "key": "tiny", "min": 0, "max": 479 }] } });